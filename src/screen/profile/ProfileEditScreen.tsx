...
import ImageRound from 'common/components/image/ImageRound';
...
import FormInputButton from 'common/components/input/FormInputButton';
        ...
        {user && (
          <WrapperColumn jc={'space-around'}>
            ...
            <WrapperColumn p="20px 0px 0px 0px">
              {userAgent !== 'APP' && <ButtonSmallBlue title="로그아웃" onClick={logoutHandler} data-cy='btn-logout'/>}
            </WrapperColumn>
            <FormWrapper>
